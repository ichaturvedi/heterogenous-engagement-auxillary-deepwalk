...
def generate_embeddings(d,w,hs,corpus,save_emb,outputfile):
    #Train model
...
def process(args):
    ...
    G, subs_coo = Graph.parse_mat_file(inputfile)
    ...
    if load_emb:    	
        ...
        if readEmbedFlag == False:
            ...
            word_vec = generate_embeddings(dimensions, window, hs, corpus, save_emb, outputfile)
...
def main():
    ...
    parser.add_argument("-i", default="network.mat", help='Input file name')
    parser.add_argument("-emb", default="embeddings.txt", help='Output file name')
